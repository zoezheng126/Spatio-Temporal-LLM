...
if __name__ == "__main__":
    ...
    new_path = result_json_path.replace(".json", "_aftergemini_furnitureaffordanceflash2.json")
    ...
    for idx in range(start_idx, len(data)):
        ...
        if qa_item['metadata']['question_type'] != 'furniture_affordance':
            print(f"Question type mismatch: {qa_item['metadata']['question_type']} != furniture_affordance")
            continue
