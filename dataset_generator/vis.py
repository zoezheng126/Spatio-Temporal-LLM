...
def generate_masks_for_image(image_name, masks_info, output_directory=None,image_path=None,object_keys=None,is_overlay=False, images_root_directory= '.', input_resolution=(1920,1080), output_resolution=(1920,1080)):
    ...
    if (not np.all(img == 0)):
        ...
        if is_overlay or image_path is not None:
            ...
            if image_path is None:
                ...
                image1_overlay = Image.open(image_path)
